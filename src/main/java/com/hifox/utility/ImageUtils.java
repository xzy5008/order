...
public class ImageUtils {
    ...
    public static void mainx(String[] args) {
        // 1-缩放图像：
        // 方法一：按比例缩放
        ImageUtils.scale("e:/aa.jpg", "e:/22.jpg", 1);//测试OK
        // 方法二：按高度和宽度缩放
        ImageUtils.scale2("e:/aa.jpg", "e:/copy.jpg", 100, 100, true);//测试OK
...
//        ImageUtils.pressImage("e:/abc2.jpg", "e:/abc.jpg","e:/abc_pressImage.jpg", 0, 0, 0.5f);//测试OK
	 ...
	 * @param file
	 */
	public static void base64StringToImage(String base64String, File file,String fileType,String ver) {
		try {
//			try {
////				if(StringUtil.isNotNull(ver) && ver.indexOf("IOS")>=0) {
////					base64String = java.net.URLDecoder.decode(base64String, "UTF-8");
////				}
//			} catch (UnsupportedEncodingException e) {
//				throw new RuntimeException("二进制转 URLDecoder.decode 异常");
//			}
			byte[] bytes1 = decoder.decodeBuffer(base64String);
			
			ByteArrayInputStream bais = new ByteArrayInputStream(bytes1);
			BufferedImage bi1 = ImageIO.read(bais);
			ImageIO.write(bi1, fileType, file);// 不管输出什么格式图片，此处不需改动
		} catch (IOException e) {
			throw new RuntimeException("二进制转图片错误");
		}
	}
}